...
const AstroPanel = (props) => {
  ...
  const searchBtn = <div className="astro-panel-search"><img src={searchImg} className="astro-panel-search-btn"/></div>
  const filterBtn = <div className="astro-panel-filter"><img src={filterImg} className="astro-panel-filter-btn"/></div>
  const sortBtn = <div className="astro-panel-sort"><img src={sortImg} className="astro-panel-sort-btn"/></div>
  return (
